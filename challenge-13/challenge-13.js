(function(){
    ...
    */
    ...
    let sudeste = ['Espirito Santo', 'Minas Gerais', 'Rio de Janeiro', 'Sao Pualo'];
    ...
    */
    ...
    brasil.unshift('Tocantins', 'Para','Amapa');
    console.log(brasil);
    ...
    */
  // console.log(`SPLICE: ${array2.slice(0,3)}`);// INICIO - FIM
    ...
    */
    ...
    chamada `newSudeste`.
    */
   //console.log(`Removendo os valores ${array2.splice(3)}`)
    let newSudeste = brasil.splice(5,8);
   ...
   //voltar
    ...
    let resultado = brasil.every(function(item){
