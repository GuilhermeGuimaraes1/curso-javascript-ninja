(function(){
    ...
    */
    ...
    let nome = ['Gui','lher','me'];
    let reduce = nome.reduce(function(acumulado, atual){
        return `${acumulado}p${atual}`
       // return  acumulado + 'p' + atual;d
    },'');
    console.log(reduce);
    ...
    */
    console.log( '\nInversed Name:' );
    let inversedName = nome.reduceRight(function(acunulado, atual){
        return acunulado + atual;
    });
