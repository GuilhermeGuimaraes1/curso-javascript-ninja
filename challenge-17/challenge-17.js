(function(){
    ...
    */
    ...
    console.log(text.replace(/Manuel Marques de Sousa/, "Guilherme Rosa Guimarães"));
    ...
    */
    ...
    console.log(text.replace(/brasileiro/, 'Morrinhese'));
    ...
    */
    ...
    console.log(text.replace(/[D-Zd-h] /g, "0"));
    ...
    */
    ...
    console.log("O mês de março é representado pelo número "+ getMonthNumber('marco') + ".");
