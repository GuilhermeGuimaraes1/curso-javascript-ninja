...
/*
    ...
    */
    ...
    function cleanCPF(cpf){
        return cpf.replace(/\D/g, ''); //pega tudo que não e numero e coloca um espaço em branco
    }
    let cpfs = ["049-214 3421-1", //pegando todos os cpfs e limpando
                "210.458.522-05",
                "735 500 794 - 22",
                '101.123-131x32'
            ]; 
    ...
    */
    ...
    cpfs.forEach(function(cpf){
        //pega todos os intelavos de numeros e coloca um ponto
    ...
    */
    ...
    console.log("<div><section><blockquote>Texto <img /></blockquote></section></div>"
                 .match(/<\w+>/g)); //todos caracteres dentro de <>
    ...
    */
    ...
    console.log("<div><ul><li></li><li></li><li><span></span></li></ul></div>"
                .match( /<\w+><\/\w+>/g)); //<pega todos caracteres> </pega todos os caracteres>
    /*
